...
#define STRING_CONFIG_H_AUTHOR "(Tronxy X3 config)" // Who made the changes.
...
//Tronxy Bed
#define  DEFAULT_bedKp 4.89
#define  DEFAULT_bedKi 0.96
#define  DEFAULT_bedKd 16.57
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, 95 }   //Original e-steps was 90
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -49.5, -15.25, -2.05 }
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION
    ...
    #define MESH_TEST_BED_TEMP      72    // (°C) Default bed temperature for the G26 Mesh Validation Tool.
...
#define SKEW_CORRECTION
  ...
  #define XY_DIAG_AC 281.66
  #define XY_DIAG_BD 282.78
  #define XY_SIDE_AD 199.80
  ...
  #define SKEW_CORRECTION_FOR_Z
    ...
    #define XZ_DIAG_AC 280.04
    #define XZ_DIAG_BD 281.90
    #define YZ_DIAG_AC 279.86
    #define YZ_DIAG_BD 280.90
    #define YZ_SIDE_AD 199.70
...
//#define RGBW_LED
  ...
  #define RGB_LED_R_PIN PC9
  #define RGB_LED_G_PIN PC6
  #define RGB_LED_B_PIN PC7
